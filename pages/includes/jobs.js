			...
			if (response) {
				...
				for( var i = 0; i<len; i++){
					...
					if (n > jobs_sched_date) {
						content += "<td><a class='btn btn-danger btn-xs job_modal' target-id='"+id+"'>"+jobs_sched_date+"</a></td>";
					}else{
						content += "<td><a class='btn btn-success btn-xs job_modal' target-id='"+id+"'>"+jobs_sched_date+"</a></td>";
					}
				...
				success: function(response){
					if (response) {
						...
						for( var i = 0; i<len; i++){
							...
							if (n > jobs_sched_date) {
								content += "<td><a class='btn btn-danger btn-xs job_modal' target-id='"+job_id+"'>"+jobs_sched_date+"</a></td>";
							}else{
								content += "<td><a class='btn btn-success btn-xs job_modal' target-id='"+job_id+"'>"+jobs_sched_date+"</a></td>";
							}
							content +="<td>Worksheet</td>";
							content += "<td>New</td>";
							if (checkbox_ref2 == 1) {
