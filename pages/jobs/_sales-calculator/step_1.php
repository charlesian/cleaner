     <style type="text/css">
        ...
        @media screen and (max-width: 600px) {
          .phoneContent2 {display:none;visibility: hidden;}
    ...
    <div class="card card-default collapsed-card">
      ...
      <div class="card-body">
        ...
        <div class="row">
          ...
          <div class="col-md-1">
            <div class="form-group">
              <button class="btn btn-default btn-xs" disabled id="show_total_selected_cal"><font id="count_jobs"></font>Jobs £ <font id="sum_pound"></font></button>
            </div>
          </div>
          <div class="col-md-1">
            <div class="form-group">
